...
<main class="recruitment">
  ...
  <section class="container edupia-mw-1230 header-title">
    <div class="text-center">
      <p class="text-font-size-30 text-font-weight-500 mb-0">Phát Triển Sự Nghiệp Đáng Mơ Ước Cùng Edupia</p>
      <div class="desc-title text-font-size-18 text-font-weight-300">
        <p class="mb-0">Edupia luôn mong muốn đồng hành cùng những cá nhân với niềm đam mê chinh phục thử thách</p>
        <p class="mb-0">và khao khát tạo dựng giá trị cho xã hội.</p>
      </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-sm-2 my-1 px-0 select-location">
        <div class="form-group">
          <select class="select-cus form-select rounded-pill w-100 text-font-size-18 text-font-weight-400" aria-label="Select Example">
  ...
  <section class="other-position edupia-mw-1230 container">
    {{-- <div class="position-list-job container edupia-mw-1230 page"> --}}
