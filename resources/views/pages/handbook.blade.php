...
<main class="handbook">
  ...
  <section class="container edupia-mw-1230 other-handbook">
    ...
    <div class="document-list page">
      <div class="col-3">
        <div>
          <img width="100%" src="{{ asset('images/imgs/other/handbook-pic-2.png') }}" alt="handbook-pic-1" />
        </div>
        <div class="short-content">
          <p class="title text-font-size-20 text-font-weight-600 mt-3">Bạn muốn con giỏi tiếng Anh trước tuổi lên 10?</p>
          <div class="author d-flex text-font-size-16 text-font-weigh-300">
