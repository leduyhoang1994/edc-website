    ...
    <div class="edupia-container-lg">
      ...
      <div class="row align-items-center list-learning-pack">
        ...
        <div class="col-sm-6 txt-learning-pack">
          ...
          <p class="text-font-weight-400 text-font-size-20">
            Sách từ vựng giúp trẻ luyện thêm bài tập nhằm nắm vững kiến thức về từ vựng và mẫu câu học sinh
            đã
      ...
      <div class="row align-items-center list-learning-pack-3">
        ...
        <div class="col-sm-6 txt-learning-pack-3">
          <p class="text-font-size-36 text-font-weight-700 text-blue-primary title-book">10 quyển truyện tranh
          </p>
          <p class="text-font-weight-400 text-font-size-18">
      ...
      <div class="row align-items-center list-learning-pack-5">
        ...
        <div class="col-sm-6 txt-learning-pack-5">
          ...
          <p class="text-font-weight-400 text-font-size-18">
            Giúp con cùng các bạn vui chơi gắn kết với trò chơi trí tuệ vô cùng hấp dẫn. Từ đó, Giảm nguy cơ
            trẻ
      ...
      <div class="row middle-img">
        <div class="col-sm">
          <p class="text-font-size-36 text-font-weight-700 text-center">Con chưa bao giờ học tiếng Anh vui
            đến
            thế</p>
